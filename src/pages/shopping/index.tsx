    ...
    >
      ...
      >
        <SwiperItem>
          <Image
            src={
              'https://storage.heimaqf.cn/kechuangyun/image/2022/1/h5_%E5%B0%8F%E7%A8%8B%E5%BA%8F%E5%A4%B4%E5%9B%BE@2x_05c544a28f33476e9cacba9952a61ed5.png'
            }
            className={'imgSwiper'}
          ></Image>
        </SwiperItem>
      ...
      <View className="productListOut">
        ...
        <View className="productList">
            ...
            productList[activeTab].map((i, index) => {
              return (
                <View className="productItem">
                  ...
                  <View className="productItemTitle">{i.title}</View>
                  <View className="productItemDesc">{i.desc}</View>
          ...
          {/* 列表状态 */}
          {productList && <AtLoadMore className="loadTip" status={status} />}
        </View>
      </View>
    </ScrollView>
  );
